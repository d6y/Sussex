...
load c_errrt.p
vars pats;
load product_code.p ;;; required by next line
load rt_cor.p
...
vars pats = pdp3_getpatterns('patterns/PROB-ONE',65,17,32,true);
testnet('~/marith/networks/new10','~/marith/weights/one-of-n/equ10-');
