...
for Ext in [b c d e] do

vars oedev = fopen('~/marith/development/oe-'><Ext><'.plt',"w");
vars odedev = fopen('~/marith/development/ode-'><Ext><'.plt',"w");
vars omitdev = fopen('~/marith/development/omit-'><Ext><'.plt',"w");
vars errdev = fopen('~/marith/development/err-'><Ext><'.plt',"w");
...
test_errrt('~/marith/networks/new10',
    '~/marith/development/weights/tolerance0_25/dev'><Ext><'-', 0.4, 0.9, 25);
